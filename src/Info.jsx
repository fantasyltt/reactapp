    ...
    <div>
      ...
      <div className="skill">
        ...
        <div className="self">
          ...
          精通PS、Sketch、C4D、AI、AE等设计工具；10年以上互联网工作经验，主导网页、APP、小程序的B端/C端等类多种类型项目；具备多个行业领域设计经验；拥有深厚的设计理论与娴熟的设计技巧了解并关注行业流行趋势；有成熟的设计作品、良好的创意构思能力；懂前端；具备良好的合作态度与团队精神，并富有工作激情、创造力和责任感；
          </div>
        </div>
    </div>
  );
