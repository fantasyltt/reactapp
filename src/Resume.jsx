          ...
          <ul>
            <li>
              ...
              <div className="workText">
                <p>1. 配合市场部推广设计相关广告和推广页;</p>
                <p>2. 制定UI设计界面规范，更改原型图交互效果产品初期挖掘用户需求，协助产品经理捋顺产品逻辑;</p>
                <p>3. 产品初期挖掘用户需求，协助产品经理捋顺产品逻辑;</p>
                <p>4. 负责产品视觉设计及交互效果，提升产品品质与用户体验;</p>
                <p>5. 配合开发人员实现产品，并对产品进行测试;</p>
                <p>6. 制作app广告视频;</p>
                <p>7. 少量前端开发;</p>
              </div>
            </li>
            <li>
              ...
              <div className="workText">
                <p>1. 负责金融类移动端网站页面的整体美工创意、设计和页面的重构;</p>
                <p>2. 根据产品方案，完善网站页面和手机APP产品界面;</p>
                <p>3. 配合产品经理对公司线上活动广告宣传进行创意策划、排版、美工设计;</p>
                <p>4. 负责跟踪产品效果及用户体验，提出设计优化方案;</p>
                <p>5. 分析当下流行趋势，定义并迭代符合金融行业的运营视觉设计方案;</p>
              </div>
            </li>
            <li>
              ...
              <div className="workText">
                <p>1. 负责PC端和移动端界面设计，跟踪产品效果，提出设计改善方案，把控设计周期和效果图设计;</p>
                <p>2. html、css3以及bootstrap对页面原型进行布局搭建;</p>
                <p>3. 根据产品方案，完善网站页面和手机APP产品界面;</p>
                <p>4. 负责各类专题页面、活动页面、图标制作、banner广告设计;</p>
                <p>5. 项目改版、维护版本迭代、产品设计项目推广;</p>
              </div>
            </li>
          </ul>
        </div>
